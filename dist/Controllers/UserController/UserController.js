...
var LoginRequest_1 = require("../../Models/Request/LoginRequest");
...
var UserController = /** @class */ (function (_super) {
    ...
    function UserController(userService) {
        ...
        _this.UserLogin = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var result, userLoginData, validate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userLoginData = req.body;
                        validate = LoginRequest_1.ValidateLoginRequest(userLoginData);
                        if (!validate.isOk) {
                        ...
                        return [4 /*yield*/, this.userService.UserLogin(userLoginData)];
                    case 1:
                        result = _a.sent();
                        if (result == null) {
                            ResponseUtils_1.ResponseJSON(req, res, {
